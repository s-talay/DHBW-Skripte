...
print("[",len(str(int(m1))),"]","c1: ",hex(m1))
print("[",len(str(int(m2))),"]","c2: ",hex(m2))
print("[",len(str(int(m3))),"]","c3: ",hex(m3))
print("[",len(str(int(m4))),"]","c4: ",hex(m4))
print("[",len(str(int(m5))),"]","c5: ",hex(m5))
